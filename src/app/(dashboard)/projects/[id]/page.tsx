      ...
      <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="px-2.5 py-0.5 rounded-md bg-rose-50 text-rose-700 font-mono text-xs font-bold border border-rose-200">
              ...
              <div key={item.id} className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-2 text-xs">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-slate-600 mt-0.5">Bahan: <strong className="text-slate-800">{item.material}</strong></p>
                  </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 pt-2 border-t border-slate-200 text-slate-700">
                  <div>
                    <span className="text-slate-500 block text-[10px]">Ukuran Bersih:</span>
                    <span className="font-bold text-slate-900">{item.heightCm} x {item.widthCm} cm</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block text-[10px]">Modul LED:</span>
                    <span className="font-bold text-rose-600">{item.ledCount || 0} Modul</span>
                  </div>
                  <div>
                    <span className="text-slate-500 block text-[10px]">Trafo Safety:</span>
                    <span className="font-bold text-emerald-600">{item.trafoWatt || 100}W Rainproof</span>
                  </div>
                </div>
